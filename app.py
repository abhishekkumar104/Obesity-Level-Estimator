...
age=st.number_input("Age: (in year)",min_value=5.,max_value=100.,value=None)
ht=st.number_input("Height: (in metre)",min_value=1.,max_value=2.75,value=None )
wt = st.number_input("Weight: (in kg)",min_value=10.,max_value=173.,value =None )
